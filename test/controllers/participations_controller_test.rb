...
class ParticipationsControllerTest < ActionController::TestCase
  ...
  test "should create participation" do
    assert_difference('Participation.count') do
      post :create, participation: { company_id: @participation.company_id, exhibition_id: @participation.exhibition_id, year: @participation.year }
    end
  ...
  test "should update participation" do
    patch :update, id: @participation, participation: { company_id: @participation.company_id, exhibition_id: @participation.exhibition_id, year: @participation.year }
    assert_redirected_to participation_path(assigns(:participation))
  end
